  ...
  return (
    <div className="space-y-[3px]">
      <div className="flex justify-between items-center">
        <span className="text-[9px] tracking-widest text-jarvis-dim uppercase">{label}</span>
        ...
        <div className="space-y-3">
          ...
          <div className="pt-2 border-t border-white/10 space-y-1">
            <div className="flex justify-between text-[9px]">
              ...
              <span className="text-jarvis-text">{system.memUsedGB} / {system.memTotalGB} GB</span>
            </div>
            <div className="flex justify-between text-[9px]">
              <span className="text-jarvis-dim">DISK FREE</span>
              <span className="text-jarvis-text">{system.diskFreePct}% ({system.diskTotalGB - system.diskUsedGB} GB)</span>
            </div>
            <div className="flex justify-between text-[9px]">
              <span className="text-jarvis-dim">UPTIME</span>
              <span className="text-jarvis-cyan">{uptimeStr(system.uptimeSec)}</span>
            </div>
          </div>
        </div>
      )}
